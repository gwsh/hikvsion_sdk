package com.csyfxx.hikivision.api;

import com.csyfxx.hikivision.original.FMSGCallBack_V31;
import com.csyfxx.hikivision.original.HCNetSDK;
import com.csyfxx.hikivision.original.OsSelect;
...
//        m_strLoginInfo.byLoginMode=0;  //ISAPI登录
     ...
     * @return
     */
    public static SdkActionResult NET_DVR_StartListen_V30(String serverIp, short serverPort, HCNetSDK.FMSGCallBack fmsgCallBack_v31) {
